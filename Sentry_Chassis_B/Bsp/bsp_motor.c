...
void chassis_message_process(uint8_t *message, shoot_referee_t *referee)
{
    ...
    switch (message[1])
    {
        ...
        case 0x02:
            ...
            break;
        case 0x03:
            referee->max_heat = 100;
            break;
        case 0x04:
            referee->max_heat = 150;
            break;
        case 0x05:
            referee->max_heat = 200;
            break;
        case 0x06:
            referee->max_heat = 280;
            break;
        case 0x07:
            referee->max_heat = 300;
            break;
        case 0x08:
            referee->max_heat = 350;
            break;
        case 0x09:
            referee->max_heat = 400;
            break;
        case 0x0A:
            referee->max_heat = 500;
            break;
        case 0x0B:
            referee->max_heat = 120;
            break;
        case 0x0C:
            referee->max_heat = 180;
            break;
        case 0x0D:
            referee->max_heat = 240;
            break;
