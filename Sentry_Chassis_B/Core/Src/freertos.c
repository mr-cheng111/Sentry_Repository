...
void Power_Control_Task_Start(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(Power_Control, Power_Control_Task_Start, osPriorityNormal, 0, 512);
  ...
  osThreadDef(Referee_Task, Referee_Task_Start, osPriorityBelowNormal, 0, 512);
...
/* USER CODE BEGIN Header_Power_Control_Task_Start */
/**
  * @brief  Function implementing the Power_Control thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Power_Control_Task_Start */
__weak void Power_Control_Task_Start(void const * argument)
{
  /* USER CODE BEGIN Power_Control_Task_Start */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Power_Control_Task_Start */
}
